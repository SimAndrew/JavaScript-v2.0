...
function t4() {
    ...
    document.querySelector('div.out-4').innerHTML = out;
}
...
function t11() {
    div11 = document.querySelectorAll('.div-11');
    let out = '';

    for (let i = 0; i < div11.length; i++) {
        out += div11[i].textContent + '_';
    }
...
function t13() {
    let iValue = document.querySelectorAll('.i-13');
