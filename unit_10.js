...
let ar3 = [2, 6, 12, 50, 110, 441, 84, 38];
...
function f10() {
    let elFirst = ar10[1];
    let elLast = ar10[ar10.length - 1];
    document.querySelector('.out-10').innerHTML = elFirst + elLast;
}
