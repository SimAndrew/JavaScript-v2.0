...
function f5() {
    ...
    if (i5.checked) {
        out5.innerHTML = document.querySelector('.i-5').value;
    }
    else {
...
function f9() {
    let r9 = document.querySelector('.r-9').checked;
    let rVal = document.querySelector('.r-9').value;
...
function f15() {
    ...
    document.querySelector('.t-15').value = i15;
