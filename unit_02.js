...
function t9() {
    ...
    document.querySelector('.out-9').innerHTML = data2;
...
function t10() {
    ...
    document.querySelector('.out-10').innerHTML = data3 * 20;
}
...
function t11() {
    ...
    document.querySelector('.out-11').innerHTML = data4 + 55;
}
...
function t16() {
    let data6 = +document.querySelector('.i-16-1').value;
    let data7 = +document.querySelector('.i-16-2').value;
    document.querySelector('.out-16').innerHTML = data6 + data7;
}
...
function t19() {
    ...
    let c = a + b;
    document.querySelector('.out-19').innerHTML = parseInt(c);
}
